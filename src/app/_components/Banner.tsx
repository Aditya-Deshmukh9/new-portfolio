        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 sm:mx-14 lg:px-8 lg:py-16">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 mt-20">
            ...
            <div className="lg:py-24 ml-8">
              ...
              <TextGenerateEffect
                className="text-3xl font-bold lg:pb-2 uppercase font-secondary sm:text-5xl"
                words={`Aditya Deshmukh`}
              />
              ...
              <TextGenerateEffect
                words={`My future goal is to create exitsing projects that use for Industry Development`}
              />
